const experiences = [
  {
    ...
    company: "Freelance",
    descrption: "N/A",
    technologies: ["React", "Unity", "C#", "Java"],
    current: true,
  },
  {
    period: "2023 - 2026",
    ...
    company: "Freelance",
    descrption: "Student of Bachelor of Computer Application from Graphic Era University Dehradun",
    technologies: ["C++", "Python", "JavaScript", "MySQL"],
    current: false,
  },
];
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className='max-w-3xl mb-16'>
            ...
            <p className="text-muted-foreground animate-fade-in animation-delay-200">
              ...
              software engineer building products at scale. 
            </p>
          </div>
          {/* Timeline */}
                ...
                >
                  ...
                  <div className={`pl-8 md:pl-0 ${idx % 2 === 0 ? "md:pr-16 md:text-right" : "md:col-start-2 md:pl-16"}`}>
                    <div className={`glass p-6 rounded-2xl border border-primary/30 hover:border-primary/50 transition-all duration-500`}>
                      ...
                      <p className="text-sm text-muted-foreground mt-4">{exp.descrption}</p>
